...
## Overview
The app demonstrates the use of main Wirecard ePOS APIs. It is aimed at SDK Integrator partners wishing to see the quickest way on how to integrate Wirecard ePOS SDK.
...
## Installation
The project is using WDePOS SDK through cocoapods.
...
Wirecard-ePOS Demo is available under the MIT license. See the LICENSE file for more info.
